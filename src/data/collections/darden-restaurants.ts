...
export const dardenRestaurants: Collection = {
    ...
    experiences: [
        ...
        },
        {
            ...
            imageUrl: '/darden/bahama_breeze.webp',
            date: 'October 3, 2019'
        },
        {
            id: 'yard-house',
            ...
            imageUrl: '/darden/yard_house.webp',
        ...
        },
        {
            ...
            imageUrl: '/darden/capital_grille.webp',
        ...
        },
        {
            ...
            imageUrl: '/darden/longhorn_steakhouse.webp',
        ...
        },
        {
            ...
            imageUrl: '/darden/olive_garden.webp',
        ...
        },
        {
            ...
            imageUrl: '/darden/seasons_52.webp',
